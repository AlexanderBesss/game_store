...
export class init1570017467140 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `games` (`id` int NOT NULL AUTO_INCREMENT, `title` varchar(40) NOT NULL, `price` int UNSIGNED NOT NULL DEFAULT 0, `tags` text NULL, `releaseDate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `publisherId` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
